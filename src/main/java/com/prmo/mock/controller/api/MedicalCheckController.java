...
public class MedicalCheckController {
    ...
    public ResponseEntity<DriverStartResponseDto> startExaminationForDriver(@RequestBody @Valid DriverStartRequestDto dto) {
    ...
    public ResponseEntity<?> endExaminationForDriver(@PathVariable Long checkId,
                                                     @RequestBody @Valid DriverEndRequestDto dto) {
